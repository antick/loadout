...
/** Presets in the user's order: drag to reorder, right-click to edit or delete, "+" to create. */
export function PresetsGroup(): ReactNode {
            ...
            <SidebarNavItem
              ...
              contextMenu={
                <>
                  ...
                  <ContextMenuItem variant="destructive" onSelect={() => void askDelete(preset)}>
                    {t("common.delete")}
                  </ContextMenuItem>
                </>
              }
