...
| Navigation               | Activity bar plus a sidebar per section (home, library, agents, presets, projects, settings), ⌘B to fold, ⌘1–⌘5 shortcuts, one title bar, a status bar with backup, library, agents, deploy mode and theme                                  |
