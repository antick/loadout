...
| Release distribution    | Automated builds for macOS, Windows and Linux go into a draft GitHub release (`.github/workflows/release.yml`). Signing, notarisation and Homebrew distribution are pending.                                                                                                                                                        |
